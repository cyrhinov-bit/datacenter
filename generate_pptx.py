...
def create_presentation():
    ...
    # Theme Colors
    COLOR_BG = RGBColor(6, 13, 31)       # #060D1F Deep Navy
    COLOR_CARD = RGBColor(17, 34, 64)     # #112240 Card Navy
    COLOR_CYAN = RGBColor(0, 210, 255)    # #00D2FF Tech Cyan
    COLOR_EMERALD = RGBColor(16, 185, 129)# #10B981 Medical Green
    COLOR_WHITE = RGBColor(255, 255, 255) # Pure White
    COLOR_MUTED = RGBColor(203, 213, 225) # Slate text
    COLOR_BORDER = RGBColor(56, 189, 248) # Cyan border
    ...
    def add_header(slide, slide_num, slide_title, category="PROJET STRATÉGIQUE"):
        ...
        hdr.fill.solid()
        hdr.fill.fore_color.rgb = RGBColor(10, 25, 47)
        hdr.line.color.rgb = RGBColor(30, 58, 100)
        ...
        ftr.fill.solid()
        ftr.fill.fore_color.rgb = RGBColor(10, 25, 47)
        ftr.line.color.rgb = RGBColor(30, 58, 100)
        ...
        p_ftr.font.color.rgb = RGBColor(148, 163, 184)
    ...
    def add_card(slide, left, top, width, height, title, subtitle, icon="🔹", accent_color=COLOR_CYAN):
        ...
        card.line.color.rgb = RGBColor(40, 80, 130)
    ...
    p_rc.font.color.rgb = COLOR_MUTED
    ...
    add_card(s2, Inches(3.8), Inches(2.8), w4, Inches(3.6), "Prise de décision", "Faciliter le pilotage stratégique et opérationnel basé sur des indicateurs en temps réel.", "📊", RGBColor(168, 85, 247))
    ...
    add_card(s3, Inches(8.9), Inches(3.2), Inches(3.6), Inches(1.3), "Déployer des systèmes intégrés", "Interopérabilité et communication", "⚙️", RGBColor(168, 85, 247))
    ...
    add_card(s4, Inches(6.8), Inches(2.9), Inches(2.7), Inches(3.5), "Archivage Numérique", "Gestion électronique des documents (GED) et traçabilité.", "📁", RGBColor(168, 85, 247))
    ...
    p_b5.font.bold = True
    p_b5.font.color.rgb = COLOR_WHITE
    ...
    add_card(s5, Inches(8.9), Inches(2.6), w3, Inches(3.8), "OPENELIS", "Gestion informatisée des laboratoires de biologie médicale et du circuit des échantillons.", "🧪", RGBColor(168, 85, 247))
    ...
    add_card(s6, Inches(0.8), Inches(3.7), w2, h2, "UPID", "Identifiant Unique du Patient (notamment sous ARV) pour l'unicité et le suivi longitudinal.", "👤", RGBColor(168, 85, 247))
    ...
    p_b6.font.color.rgb = COLOR_WHITE
    ...
    p_b7_sub.font.color.rgb = COLOR_WHITE
    ...
    add_card(s9, Inches(4.8), Inches(1.8), w3, Inches(4.2), "Énergie & Onduleurs", "Photo 2 : Alimentation électrique secourue, redondance N+1 et groupes électrogènes.", "⚡", RGBColor(234, 179, 8))
    ...
    add_card(s12, Inches(3.0), Inches(2.0), w5, Inches(4.2), "Formation Continue", "Montée en compétences des agents et du personnel de santé.", "🎓", RGBColor(234, 179, 8))
    add_card(s12, Inches(5.4), Inches(2.0), w5, Inches(4.2), "Maintenance", "Maintenance préventive, SLA et gestion des pièces de rechange.", "🔧", RGBColor(249, 115, 22))
    add_card(s12, Inches(7.8), Inches(2.0), w5, Inches(4.2), "Interconnexion", "Raccordement réseau de tous les centres de santé périphériques.", "🔗", RGBColor(168, 85, 247))
    ...
    add_card(s13, Inches(4.8), Inches(1.6), w6, h6, "VSAT Gouvernemental", "Liaisons satellitaires pour les localités enclavées.", "🛰️", RGBColor(168, 85, 247))
    ...
    add_card(s13, Inches(4.8), Inches(4.1), w6, h6, "Coût de la Data", "Tarification préférentielle et partenariats opérateurs.", "💰", RGBColor(234, 179, 8))
    add_card(s13, Inches(8.9), Inches(4.1), w6, h6, "Alimentation Électrique", "Stabilité du réseau électrique et solutions solaires d'appoint.", "⚡", RGBColor(249, 115, 22))

    # ==================== SLIDE 14: Identité, Adoption et Sécurité ====================
    s14 = prs.slides.add_slide(blank_layout)
    add_header(s14, 14, "Identité, Adoption et Sécurité", "Gouvernance & Confiance")

    add_card(s14, Inches(0.8), Inches(2.0), w4, Inches(4.2), "Identifiant Unique", "Garantir l'unicité du patient et éviter les doublons dans le système sanitaire.\n\n→ IDENTIFIER", "👤", RGBColor(168, 85, 247))
    ...
    p15.font.size = Pt(22)
    p15.font.bold = True
    p15.font.color.rgb = COLOR_WHITE
    ...
    add_card(s15, Inches(6.8), Inches(3.4), w4, Inches(2.2), "Gestion du Système", "Efficience accrue des ressources matérielles et humaines.", "📊", RGBColor(234, 179, 8))
    add_card(s15, Inches(9.8), Inches(3.4), w4, Inches(2.2), "Prise de Décision", "Politiques publiques de santé fondées sur des preuves tangibles.", "🎯", RGBColor(168, 85, 247))
    ...
    output_path = "Presentation_Datacenter_Sante_CI.pptx"
